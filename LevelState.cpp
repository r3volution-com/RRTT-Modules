...
void LevelState::Init(){
    ...
    rath->getAnimation()->addAnimation("idle", Coordinate(0, 0), 1, 50.0f);
    ...
    Gun *gunArm = new Gun(Coordinate(3900, 2700), Rect<float> (0, 640, 128, 128), Game::Instance()->rM->getTexture("player"));
    ...
    enemy2 = new Enemy(Coordinate(2500,2300), Game::Instance()->rM->getTexture("Bloque"), Rect<float>(0,0,512,512), 10);
