...
${OBJECTDIR}/Hitbox.o: Hitbox.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Hitbox.o Hitbox.cpp

${OBJECTDIR}/InterpolatedCoordinate.o: InterpolatedCoordinate.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InterpolatedCoordinate.o InterpolatedCoordinate.cpp
...
${OBJECTDIR}/menuTest/main.o: menuTest/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/menuTest/main.o menuTest/main.cpp
