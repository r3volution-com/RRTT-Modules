...
void MenuState::Init(){
    ...
    principal = new Menu(game->rM->getTexture("menu-background"), game->rM->getTexture("gui-tileset"), new Rect<float>(0,544,320,64), game->rM->getFont("menu"));
    ...
    opciones = new Menu(game->rM->getTexture("menu-background"), game->rM->getTexture("gui-tileset"), new Rect<float>(0,544,320,64), game->rM->getFont("menu"));
